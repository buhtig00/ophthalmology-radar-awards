...
import { Github, GitBranch, Star, GitFork, AlertCircle, ExternalLink, Plus, Loader2 } from "lucide-react";
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">Gestiona tus repositorios y crea issues</p>
                </div>
